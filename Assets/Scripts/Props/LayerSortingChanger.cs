...
public class LayerSortingChanger : MonoBehaviour
{
    ...
    {
        if (obj.name == "Shadow" || obj.name == "Particle" || obj.name == "MagicCircle" || obj.name == "StandArea" || obj.name == "Player")
        {
            // Layer 변경
            ...
            if (obj.name == "Shadow" || obj.name == "Particle" || obj.name == "MagicCircle" || obj.name == "Player")
            {
